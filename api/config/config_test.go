...
func TestConfig(t *testing.T) {
	tests := []struct {
		...
		{"StitchTcpAddr", "STITCH_TCP_ADDR", StitchTcpAddr, "test", "", "test"},
		{"StitchGrpcAddr", "STITCH_GRPC_ADDR", StitchGrpcAddr, "test", "", "test"},
		{"StitchCmd", "STITCH_CMD", StitchCmd, "test", []string{""}, []string{"test"}},
		...
		{"ManifestURI", "MANIFEST_DB_URI", ManifestURI, "mongodb://", "", "mongodb://"},
		...
		{"AzContainerName", "AZURE_CONTAINER_NAME", AzContainerName, "scblob", "", "scblob"},
