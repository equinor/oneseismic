...
int main(int argc, char **argv)
{
    ...
    auto cli = clara::Opt(address, "bind")
                   ["-b"]["--bind"]("Address to bind, default = " + address) |
               clara::Opt(key, "key")
                   ["-k"]["--key"]("Access key") |
               clara::Opt(storage_account, "storage account")
                   ["-A"]["--account"]["--storage-account"]("Storage account for the blobs") |
               clara::Opt(max_connections, "maximum connections")
                   ["-m"]["--max-connections"]["--maximum-connections"]("Maximum curl connections, default = " + std::to_string(max_connections));
